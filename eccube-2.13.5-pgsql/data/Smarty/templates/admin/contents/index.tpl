    ...
    <form name="form1" id="form1" method="post" action="?">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <!--{if $arrErr.news_start_year || $arrErr.news_start_month || $arrErr.news_start_day}--><span class="attention"><!--{$arrErr.news_start_year}--><!--{$arrErr.news_start_month}--><!--{$arrErr.news_start_day}--></span><!--{/if}-->
                    <select name="news_start_year" <!--{if $arrErr.news_start_year || $arrErr.news_start_month || $arrErr.news_start_day }-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">----</option>
                    <!--{html_options options=$arrYear selected=$arrForm.news_start_year.value}-->
                    </select>年
                    <select name="news_start_month" <!--{if $arrErr.news_start_year || $arrErr.news_start_month || $arrErr.news_start_day}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arrMonth selected=$arrForm.news_start_month.value}-->
                    </select>月
                    <select name="news_start_day" <!--{if $arrErr.news_start_year || $arrErr.news_start_month || $arrErr.news_start_day}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arrDay selected=$arrForm.news_start_day.value}-->
                    </select>日
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <!--{if $arrErr.news_end_year || $arrErr.news_end_month || $arrErr.news_end_day}--><span class="attention"><!--{$arrErr.news_end_year}--><!--{$arrErr.news_end_month}--><!--{$arrErr.news_end_day}--></span><!--{/if}-->
                    <select name="news_end_year" <!--{if $arrErr.news_end_year || $arrErr.news_end_month || $arrErr.news_end_day }-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">----</option>
                    <!--{html_options options=$arrYear selected=$arrForm.news_end_year.value}-->
                    </select>年
                    <select name="news_end_month" <!--{if $arrErr.news_end_year || $arrErr.news_end_month || $arrErr.news_end_day}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">--</option>
                    <!--{html_options options=$arrMonth selected=$arrForm.news_end_month.value}-->
                    </select>月
                    <select name="news_end_day" <!--{if $arrErr.news_end_year || $arrErr.news_end_month || $arrErr.news_end_day}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">--</option>
    ...
    <form name="move" id="move" method="post" action="?">
        ...
        <table class="list">
            ...
            <tr style="background:<!--{if $arrNews[data].news_id != $tpl_news_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->;" class="center">
                ...
                <td><!--{$arrNews[data].cast_news_start_date|date_format:"%Y/%m/%d"}--></td>  <!--追加-->
                <td><!--{$arrNews[data].cast_news_end_date|date_format:"%Y/%m/%d"}--></td>  <!--追加-->
                <td>
